			...
			<div class="box-body">
              <img class="img-responsive pad" src="{{ asset('uploads/'.$dt->gambar) }}" alt="Photo">
	              ...
	              <div class="box-body">
	              	<div class="form-group">
	                  <label for="exampleInputEmail1">Judul</label>
	                  <input type="text" name="judul" value="{{ $dt->judul }}" class="form-control" placeholder="Judul" autofocus required>
	                </div>
	                <div class="form-group">
	                  <label for="exampleInputPassword1">Tanggal</label>
	                  <input type="text" name="tanggal" class="form-control" value="{{ $dt->tanggal }}" placeholder="Ex: DECEMBER 25, 2015" autofocus required>
	                </div>
	                <div class="form-group">
	                  <label for="exampleInputPassword1">Keterangan</label>
