      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{ ( Request::segment(2) == 'penganten' ) ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ (Request::path() == 'admin/penganten') ? 'active' : '' }}"><a href="{{ url('admin/penganten') }}"><i class="fa fa-circle-o"></i> Data Penganten</a></li>

            <li class="{{ (Request::path() == 'admin/penganten/story') ? 'active' : '' }}"><a href="{{ url('admin/penganten/story') }}"><i class="fa fa-circle-o"></i> Kisah Cinta</a></li>
        ...
        <li class="treeview {{ ( Request::segment(2) == 'jasa' ) ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ (Request::path() == 'admin/jasa') ? 'active' : '' }}"><a href="{{ url('admin/jasa') }}"><i class="fa fa-circle-o"></i> Vendor</a></li>
